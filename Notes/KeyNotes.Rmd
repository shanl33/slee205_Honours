...
## Questions
* How do a make a data file (csv) available for the VirtualBox session?
    + Error in file(file, "rt") : cannot open the connection
    + Working directory is a temporary guest folder (eg. "/tmp/guest-rEwsjw")
    + Saved data file in the "Shared folder" used in the settings but still can't access.
* At first I was able to 'pop in and out' of the VirtualBox window but now cannot after adding a file to stat787_1 folder (adding to stat787 folder seemed to be ok)
