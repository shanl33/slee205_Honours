...
* Which combination will result in smoother animation: (`plotly`+`shiny`) or (`plotly`+`crosstalk`)?
    + They appear to be the same 'speed' but the tour plot and slider are more in sync and smoother, when using (`plotly`+`crosstalk`). 
...
## tourr (R package)
* See: <https://www.jstatsoft.org/article/view/v040i02/v40i02.pdf>
