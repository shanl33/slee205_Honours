...
## What is GDA?
- Used for *data cleaning, exploring data structure, detecting outliers and unusual groups, identifying trends and clusters, spotting local patterns, evaluating modelling output and presenting results* (p.xi) 
...
- GDA and statistical analysis complement each other. Results found graphically should be supported by statistical analysis, and vice versa.
    ...
    + Often possible to find a graphic to support results of a statistical test but not so the other way around (always be able to find a stats analysis to support something you discover graphically) (p.5)
