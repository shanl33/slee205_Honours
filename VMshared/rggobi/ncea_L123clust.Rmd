...
A guided tour optimising the central mass index shows the concentration of high decile schools at the centre of the plot. The schools that are further away from the central mass tend to be from lower decile schools. (This supports the findings from the supervised cluster analysis?)